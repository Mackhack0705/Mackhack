...
const Profile = () => {
  ...
  return (
    <div id='profile'  className="cursor-pointer group">
        ...
        <div className="absolute right-0 z-10 border-[1px] border-gray-300 w-[200px] top-15 text-base bg-white text-black font-normal p-2 rounded-lg invisible hover:visible group-hover:visibe">
            <div className='p-2'>
