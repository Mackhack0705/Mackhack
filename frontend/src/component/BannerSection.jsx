  ...
  return (
   <div className="w-full h-[650px]">
      <div className='flex flex-wrap justify-around items-center h-full'>
        <div className='text-left py-10 px-5 w-[500px]'>
          <div className='text-3xl font-bold text-[#01c8b5]'>Full stack Development</div>
        ...
        <div className="bg-background-texture bg-cover bg-center rounded-lg w-[550px] pt-8">
          <img id='ipad' className="absolute w-[80px] h-[80px] right-60 top-88" src="/images/ipad.png" alt="" />
          <img src="/images/img1.png" alt="" />
          <img id='book' className="absolute top-[550px] right-6 w-[100px] h-[50px]" src="/images/book.png" alt="" />
        </div>
      </div>
   </div>
  )
