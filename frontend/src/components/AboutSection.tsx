...
const AboutSection = () => {
  return (
    <div className='h-1/2 flex flex-wrap justify-around py-10 md:h-80 lg:flex-nowrap lg:h-60 lg:px-4'>
        <div className="flex flex-wrap w-4/5 flex-col gap-3 md:flex-row md:gap-10 lg:gap-1 xl:flex-col">
            <div
                id="logo"
        ...
        <div className="flex flex-wrap items-center w-4/5 flex-col py-2 md:flex-row md:justify-center lg:flex-nowrap lg:items-start lg:py-0">
            <div className="p-2 text-lg font-semibold w-full md:w-52 md:ml-24 lg:p-0">
                <ul>
            ...
            <div className="p-2 text-lg font-semibold w-full md:w-52 lg:p-0">
                <ul>
