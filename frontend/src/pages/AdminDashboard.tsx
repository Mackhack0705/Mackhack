...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex flex-wrap justify-center py-20">
      <div className="flex flex-wrap w-full justify-center gap-4 mx-4 text-center items-center md:justify-around">
        <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Admin Dashboard</h1>
        <button onClick={() => {
          navigate("/admin/addCourse");
        }} className="border border-[#333] px-8 py-3 cursor-pointer text-sm font-semibold rounded-xl md:text-base lg:text-lg">Create Course</button>
      </div>
      <div className="my-4">
        {
          courses.map((course) => (
