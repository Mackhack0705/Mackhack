...
const Teaching = () => {
  ...
  return (
    <div className="h-screen overflow-hidden border border-red-500 flex flex-wrap md:px-10 md:justify-center lg:items-center lg:px-14 lg:flex-nowrap">
        ...
        <div className="border border-[#333] h-48 w-full rounded-lg flex justify-center items-center flex-col gap-3 md:w-[80%] lg:w-[90%]">
            ...
            <button onClick={showInstructorDashboard} className="px-3 cursor-pointer py-1 text-base border border-[#333] rounded-3xl hover:shadow-md md:text-lg md:px-4 md:py-2">Get Started</button>
        </div>
    </div>
  )
}
