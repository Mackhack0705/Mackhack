...
const Teaching = () => {
  ...
  return (
    <div className="flex-1 flex flex-wrap mx-4 gap-2 md:px-10 md:justify-center lg:items-center lg:px-14 lg:flex-nowrap">
      ...
      <div className="border border-[#333] h-60 w-full rounded-lg flex justify-center items-center flex-col gap-3 md:w-[80%] lg:w-[90%]">
        ...
        <button
          ...
          className="px-8 cursor-pointer py-3 text-base border border-[#333] rounded-3xl hover:shadow-md md:text-lg md:px-4 md:py-2"
        >
          Get Started
        </button>
      </div>
